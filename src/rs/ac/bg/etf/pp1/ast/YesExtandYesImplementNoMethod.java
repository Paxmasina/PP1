...
public class YesExtandYesImplementNoMethod extends ClassDecl {
    ...
    public YesExtandYesImplementNoMethod (ClassName ClassName, BaseClass BaseClass, ImplementedClassList ImplementedClassList, VarDeclarations VarDeclarations) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesExtandYesImplementNoMethod(\n");
