...
public class EnumDeclarationsList extends EnumDeclList {

    private EnumDeclList EnumDeclList;
    private EnumDeclPart EnumDeclPart;

    public EnumDeclarationsList (EnumDeclList EnumDeclList, EnumDeclPart EnumDeclPart) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("EnumDeclarationsList(\n");
