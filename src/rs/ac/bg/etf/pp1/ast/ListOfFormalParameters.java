...
public class ListOfFormalParameters extends FormParsList {

    private FormParsList FormParsList;
    private FormParsDecl FormParsDecl;

    public ListOfFormalParameters (FormParsList FormParsList, FormParsDecl FormParsDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ListOfFormalParameters(\n");
