...
public class YesExtandYesImplementYesMethod extends ClassDecl {
    ...
    public YesExtandYesImplementYesMethod (ClassName ClassName, BaseClass BaseClass, ImplementedClassList ImplementedClassList, VarDeclarations VarDeclarations, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesExtandYesImplementYesMethod(\n");
