...
public class YesExtandNoImplementNoMethod extends ClassDecl {

    private ClassName ClassName;
    private BaseClass BaseClass;
    private VarDeclarations VarDeclarations;

    public YesExtandNoImplementNoMethod (ClassName ClassName, BaseClass BaseClass, VarDeclarations VarDeclarations) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesExtandNoImplementNoMethod(\n");
