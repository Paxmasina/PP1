...
public class VarDeclerationsList extends VarDeclList {

    private VarDeclList VarDeclList;
    private VarDeclPart VarDeclPart;

    public VarDeclerationsList (VarDeclList VarDeclList, VarDeclPart VarDeclPart) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclerationsList(\n");
