...
public class ForStatementC extends MatchedStatement {

    private Condition Condition;
    private MatchedStatement MatchedStatement;

    public ForStatementC (Condition Condition, MatchedStatement MatchedStatement) {
